        ...
        <el-tab-pane label="基本信息" name="info">
          ...
          >
            ...
            <el-form-item label="选择车辆" prop="cid">
              <el-select v-model="dataForm.cid" placeholder="" clearable class="filter-item" style="width:185px">
                <el-option v-for="(item,value,index) in car" :key="index" :label="item.number" :value="item.id" />
              </el-select>
            </el-form-item>
            <el-form-item label="司机" prop="driver">
              <el-select v-model="dataForm.driver" placeholder="" clearable class="filter-item" style="width:185px">
                <el-option v-for="(item,value,index) in driver" :key="index" :label="item" :value="Number(value)" />
              </el-select>
            </el-form-item>
            <!-- <el-form-item label="司机" prop="driver">
  ...
  methods: {
    ...
    getCommon(v) {
      createcarcommon().then(res => {
        ...
        this.driver = res.data.drivername
